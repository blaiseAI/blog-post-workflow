  ...
  if (postsArray.length > 0) {
    try {
      ...
      if (newReadme !== readmeData) {
        ...
        // Calculating last commit date, please see https://github.com/gautamkrishnar/blog-post-workflow/issues/53
        ...
        if (diffInDays > 50 && !process.env.TEST_MODE) {
          ...
          core.info('Doing dummy commit to keep workflow active, see https://github.com/gautamkrishnar/' +
            'blog-post-workflow/issues/53');
